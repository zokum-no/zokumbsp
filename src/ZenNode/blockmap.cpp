...
// Stuff that doesn't change with offset :)
void BlockMapExtraData( DoomLevel *level, sBlockMapExtraData *extraData, const sBlockMapOptions &options) {
...
sBlockMap *GenerateBLOCKMAP ( DoomLevel *level, int xOffset, int yOffset, sBlockMapExtraData *extraData, const sBlockMapOptions &options) {
...
int CreateBLOCKMAP ( DoomLevel *level, const sBlockMapOptions &options ) {
	...
	for (int offsetY = offsetYMin; offsetY <= offsetYMax; offsetY += offsetIncreaseY) {
		...
		for (int offsetX = offsetXMin; offsetX <= offsetXMax; offsetX += offsetIncreaseX) {
			...
			blockMap = GenerateBLOCKMAP ( level, offsetX, offsetY, extraData, options);
